<div id="content-container">
    ...
    <div id="content">
        ...
        <div id="body">
            ...
            echo "<br/>";
            echo form_input(array('name' => 'usuario', 'id' => 'usuario', 'maxlength' => '100'));
            echo "</p>";

            echo "<p>";
            echo form_label('Nome', 'nome');
            echo "<br/>";
            echo form_input(array('name' => 'nome', 'id' => 'nome', 'maxlength' => '100'));
            echo "</p>";

            echo "<p>";
            echo form_label('E-mail', 'email');
            echo "<br/>";
            echo form_input(array('name' => 'email', 'id' => 'email', 'maxlength' => '100'));
            echo "</p>";
